<!DOCTYPE html>
<html lang="zh-cn">
<?php $title='全局 CSS 样式 · Bootstrap 中文文档';?>
...
<span class="nt">&lt;/table&gt;</span>
  ...
  <h2 id="tables-noborder">无边框的表格</h2>
  <p>添加 <code>.table-noborder</code> 类为表格和其中的每个单元格去除边框。</p>
  <div class="bs-example">
  ...
  <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-noborder"</span><span class="nt">&gt;</span>
        ...
        <span class="nt">&lt;/table&gt;</span>
      </code></pre></div>
...
<span class="p">}</span>
  ...
  <div class="bs-callout bs-callout-warning">
    ...
    <p>To align components in navbars with utility classes, use <code>.navbar-left</code> or <code>.navbar-right</code> instead. <a href="http://v3.bootcss.com/components/#navbar-component-alignment">See the navbar docs</a> for details.</p>
  </div>
...
<span class="p">}</span>
  ...
  <p>Hide an element to all devices <strong>except screen readers</strong> with <code>.sr-only</code>. Combine <code>.sr-only</code> with <code>.sr-only-focusable</code> to show the element again when it's focused (e.g. by a keyboard-only user). Necessary for following <a href="http://v3.bootcss.com/getting-started/#accessibility">accessibility best practices</a>. Can also be used as mixins.</p>
...
<div class="bs-docs-section">
  ...
  <p>Bootstrap can be used in at least two ways: with the compiled CSS or with the source Less files. To compile the Less files, <a href="http://v3.bootcss.com/getting-started/#grunt">consult the Getting Started section</a> for how to setup your development environment to run the necessary commands.</p>

  <h2 id="less-variables">变量</h2>
  <p>Variables are used throughout the entire project as a way to centralize and share commonly used values like colors, spacing, or font stacks. For a complete breakdown, please see <a href="http://v3.bootcss.com/customize/#less-variables-section">the Customizer</a>.</p>
...
<li>
  ...
  <ul class="nav">
    ...
    <li><a href="#tables-noborder">无边框的表格</a></li>
