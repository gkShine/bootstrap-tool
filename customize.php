...
<script>
  ...
  <body>
    <a class="sr-only sr-only-focusable" href="http://v3.bootcss.com/customize/#content">Skip to main content</a>
  ...
  <div class="container">
    ...
    <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
        <li>
          <a href="http://v3.bootcss.com/getting-started/">起步</a>
        </li>
        <li>
        ...
        <li class="active">
          <a href="./resource/custom.html">定制</a>
        </li>
      </ul>
...
<li class="active"><a href="http://v3.bootcss.com/customize/#import-drop-target">Import</a></li>
